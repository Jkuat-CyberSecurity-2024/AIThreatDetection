"""
Django settings for ThreatDetection project.
...
WSGI_APPLICATION = 'ThreatDetection.wsgi.application'
...
JAZZMIN_SETTINGS = {
    "site_title": "AIThreat Detection Backend",
    "site_header": "AIThreat Detection Backend",
    "site_brand": "ATD",
    # "site_icon": "images/favicon.png",
    # Add your own branding here
    "site_logo": None,
    "welcome_sign": "Welcome to the AIThreat Detection Backend",
    # Copyright on the footer
    "copyright": "AIThreat Detection Backend",
    # "user_avatar": None,
    ############
    # Top Menu #
    ############
    ...
    "topmenu_links": [
        ...
        {"name": "AIThreat Detection", "url": "home", "permissions": ["auth.view_user"]},
...
CACHES = {
    'default': {
        'BACKEND': 'django_redis.cache.RedisCache',
        'LOCATION': 'redis://localhost:6379/1',  # Update host as necessary
        'OPTIONS': {
            'CLIENT_CLASS': 'django_redis.client.DefaultClient',
        }
    }
